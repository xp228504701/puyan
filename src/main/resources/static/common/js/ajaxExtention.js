        ...
        $.ajax=function(opt){
            ...
            var _opt = $.extend(opt, {
                ...
                error: function (xhr,textStatus,errorThrown) {
                    if(xhr.status === 401){
                        window.location.href = $tool.getResUrl()+"views/error/401.jsp";
                        return ;
                        ...
                        window.parent.parent.parent.parent.location.href = $tool.getResUrl()+"views/page/login2.jsp";

                        return ;
                    }else if(xhr.status === 404){
                        window.location.href = $tool.getResUrl()+"views/error/404.jsp";
                        return ;
                    }
